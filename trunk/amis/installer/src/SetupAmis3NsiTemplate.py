...
__CHEETAH_genTime__ = 1452555735.853124
__CHEETAH_genTimestamp__ = 'Mon Jan 11 15:42:15 2016'
__CHEETAH_src__ = 'SetupAmis3NsiTemplate.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Jan 11 15:42:13 2016'
...
!define COMPATIBILITY_REG_KEY "Software\\Microsoft\\Windows NT\\CurrentVersion\\AppCompatFlags\\Layers"\r
\r
;******\r
...
\r
    ...
    ; set permissions on this too; same as above but works better for non-english/more recent windows versions\r
    AccessControl::GrantOnFile "$SETTINGS_DIR\\bmk" "(S-1-5-32-545)" "FullAccess"\r
    AccessControl::GrantOnFile "$SETTINGS_DIR" "(S-1-5-32-545)" "FullAccess"\r
\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 271, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 271, col 11.
        write(u'''\\AMIS\\settings\\resource.h.ini"\r
\r
    ;copy the css files\r
    SetOutPath "$SETTINGS_DIR\\css"\r
    File "''')
        _v = VFFSL(SL,"bin_dir",True) # u'$bin_dir' on line 275, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$bin_dir')) # from line 275, col 11.
        write(u'''\\settings\\css\\*.css"\r
    SetOutPath "$SETTINGS_DIR\\css\\customStyles"\r
    File "''')
        _v = VFFSL(SL,"data_dir",True) # u'$data_dir' on line 277, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$data_dir')) # from line 277, col 11.
        write(u'''\\settings\\customStyles\\*.css"\r
    SetOutPath "$SETTINGS_DIR\\css\\font"\r
    File "''')
        _v = VFFSL(SL,"bin_dir",True) # u'$bin_dir' on line 279, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$bin_dir')) # from line 279, col 11.
        write(u'''\\settings\\css\\font\\*.css"\r
    SetOutPath "$SETTINGS_DIR\\css\\font\\ie8"\r
    File "''')
        _v = VFFSL(SL,"bin_dir",True) # u'$bin_dir' on line 281, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$bin_dir')) # from line 281, col 11.
        write(u'''\\settings\\css\\font\\ie8\\*.css"\r
\r
    ;copy the images\r
    SetOutPath "$SETTINGS_DIR\\img"\r
    File "''')
        _v = VFFSL(SL,"bin_dir",True) # u'$bin_dir' on line 285, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$bin_dir')) # from line 285, col 11.
        write(u'''\\settings\\img\\*.ico"\r
    SetOutPath "$SETTINGS_DIR\\img\\defaultToolbar"\r
    File "''')
        _v = VFFSL(SL,"bin_dir",True) # u'$bin_dir' on line 287, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$bin_dir')) # from line 287, col 11.
        write(u'''\\settings\\img\\defaultToolbar\\*.ico"\r
    SetOutPath "$SETTINGS_DIR\\img\\basicToolbar"\r
    File "''')
        _v = VFFSL(SL,"bin_dir",True) # u'$bin_dir' on line 289, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$bin_dir')) # from line 289, col 11.
        write(u'''\\settings\\img\\basicToolbar\\*.ico"\r
\r
    ;copy the lang directory readme file\r
    SetOutPath "$SETTINGS_DIR\\lang"\r
    File "''')
        _v = VFFSL(SL,"bin_dir",True) # u'$bin_dir' on line 293, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$bin_dir')) # from line 293, col 11.
        write(u'''\\settings\\lang\\readme.txt"\r
\r
    ;copy the MSVC redistributables installer\r
    SetOutPath $AMIS_TEMP\r
    File "''')
        _v = VFFSL(SL,"vs_dir",True) # u'$vs_dir' on line 297, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$vs_dir')) # from line 297, col 11.
        write(u'''\\vcredist_x86.exe"\r
\r
    ;copy the jaws scripts installer\r
    SetOutPath $AMIS_TEMP\r
    File "''')
        _v = VFFSL(SL,"jaws_scripts",True) # u'$jaws_scripts' on line 301, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$jaws_scripts')) # from line 301, col 11.
        write(u'''"\r
\r
...
\r
    ; TODO checking if the default lang = \'eng-US\' would make this a little more efficient\r
    \r
    LogEx::Write "Copying language pack files: eng-US"\r
    \r
    ;copy the langpack root files\r
    SetOutPath "$SETTINGS_DIR\\lang\\eng-US"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 324, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 324, col 11.
        write(u'''\\AMIS\\settings\\lang\\eng-US\\*"\r
\r
    ;copy the langpack audio\r
    SetOutPath "$SETTINGS_DIR\\lang\\eng-US\\audio"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 328, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 328, col 11.
        write(u'''\\AMIS\\settings\\lang\\eng-US\\audio\\*"\r
\r
    ;copy the langpack help book files (and images)\r
    SetOutPath "$SETTINGS_DIR\\lang\\eng-US\\help"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 332, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 332, col 11.
        write(u'''\\AMIS\\settings\\lang\\eng-US\\help\\*"\r
    SetOutPath "$SETTINGS_DIR\\lang\\eng-US\\help\\img"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 334, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 334, col 11.
        write(u'''\\AMIS\\settings\\lang\\eng-US\\help\\img\\*"\r
\r
    ;copy the langpack shortcut book files\r
    SetOutPath "$SETTINGS_DIR\\lang\\eng-US\\shortcuts"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 338, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 338, col 11.
        write(u'''\\AMIS\\settings\\lang\\eng-US\\shortcuts\\*"\r
\r
    LogEx::Write "Copying language pack files: ''')
        _v = VFFSL(SL,"langid",True) # u'$langid' on line 340, col 48
        if _v is not None: write(_filter(_v, rawExpr=u'$langid')) # from line 340, col 48.
        write(u'''"\r
\r
    ;copy the langpack root files\r
    SetOutPath "$SETTINGS_DIR\\lang\\${LANGID}"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 344, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 344, col 11.
        write(u'''\\AMIS\\settings\\lang\\${LANGID}\\*"\r
\r
    ;copy the langpack audio\r
    SetOutPath "$SETTINGS_DIR\\lang\\${LANGID}\\audio"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 348, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 348, col 11.
        write(u'''\\AMIS\\settings\\lang\\${LANGID}\\audio\\*"\r
\r
    ;copy the langpack help book files (and images)\r
    SetOutPath "$SETTINGS_DIR\\lang\\${LANGID}\\help"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 352, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 352, col 11.
        write(u'''\\AMIS\\settings\\lang\\${LANGID}\\help\\*"\r
    SetOutPath "$SETTINGS_DIR\\lang\\${LANGID}\\help\\img"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 354, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 354, col 11.
        write(u'''\\AMIS\\settings\\lang\\${LANGID}\\help\\img\\*"\r
\r
    ;copy the langpack shortcut book files\r
    SetOutPath "$SETTINGS_DIR\\lang\\${LANGID}\\shortcuts"\r
    File "''')
        _v = VFFSL(SL,"appdata_dir",True) # u'$appdata_dir' on line 358, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$appdata_dir')) # from line 358, col 11.
...
\t\t\tIfSilent End\r
        ...
        _v = VFFSL(SL,"text106",True) # u'$text106' on line 385, col 44
        if _v is not None: write(_filter(_v, rawExpr=u'$text106')) # from line 385, col 44.
        write(u'''"\r
        ${Else}\r
...
\r
''')
        if VFFSL(SL,"include_jaws_scripts",True) == "yes": # generated from line 395, col 1
            write(u'''\r
;******\r
...
\t\tIfSilent InstallScripts\r
        MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON1 "''')
            _v = VFFSL(SL,"text107",True) # u'$text107' on line 414, col 60
            if _v is not None: write(_filter(_v, rawExpr=u'$text107')) # from line 414, col 60.
...
\t\t\tIfSilent End\r
            MessageBox MB_ICONEXCLAMATION "''')
            _v = VFFSL(SL,"text108",True) # u'$text108' on line 423, col 44
            if _v is not None: write(_filter(_v, rawExpr=u'$text108')) # from line 423, col 44.
            write(u'''"\r
        ${EndIf}\r
        Goto End\r
\r
...
SectionEnd\r
''')
        else: # generated from line 439, col 1
...
\t\t\tIfSilent End\r
        \tMessageBox MB_OK "''')
        _v = VFFSL(SL,"text109",True) # u'$text109' on line 468, col 28
        if _v is not None: write(_filter(_v, rawExpr=u'$text109')) # from line 468, col 28.
        write(u'''"\r
        \tGoto End\r
    ${Else}\r
...
\t\tIfSilent End\r
        MessageBox MB_OK "''')
        _v = VFFSL(SL,"text110",True) # u'$text110' on line 473, col 27
        if _v is not None: write(_filter(_v, rawExpr=u'$text110')) # from line 473, col 27.
        write(u'''"\r
\t\tGoto End\r
    ${EndIf}\r
End:\r
...
Section -AdditionalIcons\r
    WriteIniStr "$INSTDIR\\${PRODUCT_NAME}.url" "InternetShortcut" "URL" "''')
        _v = VFFSL(SL,"product_website",True) # u'$product_website' on line 483, col 76
        if _v is not None: write(_filter(_v, rawExpr=u'$product_website')) # from line 483, col 76.
        write(u'''"\r
    CreateShortCut "''')
        write(_filter("$SMPROGRAMS\\AMIS\\"))
        _v = VFFSL(SL,"text119",True) # u'$text119' on line 484, col 47
        if _v is not None: write(_filter(_v, rawExpr=u'$text119')) # from line 484, col 47.
        write(_filter(".lnk"))
        write(u'''" "$INSTDIR\\${PRODUCT_NAME}.url"\r
    CreateShortCut "''')
        write(_filter("$SMPROGRAMS\\AMIS\\"))
        _v = VFFSL(SL,"text120",True) # u'$text120' on line 485, col 47
        if _v is not None: write(_filter(_v, rawExpr=u'$text120')) # from line 485, col 47.
        write(_filter(".lnk"))
        write(u'''" "$INSTDIR\\Uninstall-AMIS.exe"\r
    CreateShortCut "''')
        write(_filter("$SMPROGRAMS\\AMIS\\"))
        _v = VFFSL(SL,"text121",True) # u'$text121' on line 486, col 47
        if _v is not None: write(_filter(_v, rawExpr=u'$text121')) # from line 486, col 47.
        write(u''' (''')
        _v = VFFSL(SL,"langname",True) # u'$langname' on line 486, col 57
        if _v is not None: write(_filter(_v, rawExpr=u'$langname')) # from line 486, col 57.
        write(u''').lnk" "$SETTINGS_DIR\\lang\\${LANGID}\\help\\${HELPFILE_NAME}"\r
    CreateShortCut "''')
        write(_filter("$SMPROGRAMS\\AMIS\\"))
        _v = VFFSL(SL,"text122",True) # u'$text122' on line 487, col 47
        if _v is not None: write(_filter(_v, rawExpr=u'$text122')) # from line 487, col 47.
        write(u''' (''')
        _v = VFFSL(SL,"langname",True) # u'$langname' on line 487, col 57
        if _v is not None: write(_filter(_v, rawExpr=u'$langname')) # from line 487, col 57.
...
\r
    ...
    WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayVersion" "''')
        _v = VFFSL(SL,"product_version",True) # u'$product_version' on line 506, col 88
        if _v is not None: write(_filter(_v, rawExpr=u'$product_version')) # from line 506, col 88.
        write(u'''"\r
    WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "URLInfoAbout" "''')
        _v = VFFSL(SL,"product_website",True) # u'$product_website' on line 507, col 86
        if _v is not None: write(_filter(_v, rawExpr=u'$product_website')) # from line 507, col 86.
        write(u'''"\r
    WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "Publisher" "''')
        _v = VFFSL(SL,"product_publisher",True) # u'$product_publisher' on line 508, col 83
        if _v is not None: write(_filter(_v, rawExpr=u'$product_publisher')) # from line 508, col 83.
        write(u'''"\r
    WriteRegStr HKLM "${COMPATIBILITY_REG_KEY}" "$INSTDIR\\AMIS.exe" "~ WIN7RTM" \r
\r
...
\tIfSilent End\r
    MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "''')
        _v = VFFSL(SL,"text111",True) # u'$text111' on line 532, col 56
        if _v is not None: write(_filter(_v, rawExpr=u'$text111')) # from line 532, col 56.
        write(u'''" IDYES End\r
    Abort\r
End:\r
FunctionEnd\r
...
\tIfSilent End\r
    MessageBox MB_ICONINFORMATION|MB_OK "''')
        _v = VFFSL(SL,"text112",True) # u'$text112' on line 543, col 42
        if _v is not None: write(_filter(_v, rawExpr=u'$text112')) # from line 543, col 42.
        write(u'''"\r
End:\r
FunctionEnd\r
\r
...
\tDelete "''')
        write(_filter("$SMPROGRAMS\\AMIS\\"))
        _v = VFFSL(SL,"text114",True) # u'$text114' on line 607, col 36
        if _v is not None: write(_filter(_v, rawExpr=u'$text114')) # from line 607, col 36.
        write(u'''\\*"\r
\tDelete "$SMPROGRAMS\\AMIS\\*"\r
\r
    RMDir "''')
        write(_filter("$SMPROGRAMS\\AMIS\\"))
        _v = VFFSL(SL,"text114",True) # u'$text114' on line 610, col 38
        if _v is not None: write(_filter(_v, rawExpr=u'$text114')) # from line 610, col 38.
        write(u'''\\"\r
...
\r
    ; uninstall eng-US\r
    Delete "$SETTINGS_DIR\\lang\\eng-US\\help\\*"\r
    Delete "$SETTINGS_DIR\\lang\\eng-US\\help\\img\\*"\r
    Delete "$SETTINGS_DIR\\lang\\eng-US\\audio\\*"\r
\r
    RMDir "$SETTINGS_DIR\\lang\\eng-US\\help\\img"\r
    RMDir "$SETTINGS_DIR\\lang\\eng-US\\help"\r
    RMDir "$SETTINGS_DIR\\lang\\eng-US\\audio"\r
\r
    Delete "$SETTINGS_DIR\\lang\\eng-US\\shortcuts\\*"\r
    RMDir "$SETTINGS_DIR\\lang\\eng-US\\shortcuts"\r
\r
    Delete "$SETTINGS_DIR\\lang\\eng-US\\*"\r
    RMDir "$SETTINGS_DIR\\lang\\eng-US"\r
\r
    ; uninstall custom language\r
\r
...
\tIfSilent Remove\r
    MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "''')
        _v = VFFSL(SL,"text113",True) # u'$text113' on line 658, col 56
        if _v is not None: write(_filter(_v, rawExpr=u'$text113')) # from line 658, col 56.
