...
Function .onInit
	...
	Error:
		IfSilent +2
		MessageBox MB_ICONSTOP "Ο φάκελλος $SETTINGS_DIR με τις ρυθμίσεις του AMIS δεν βρέθηκε."
		Abort
...
Function un.onInit
  IfSilent End
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Είστε σίγουροι ότι θέλετε να αφαιρέσετε πλήρως το $(^Name) και όλα τα συστατικά του;" IDYES +2
  Abort
End:
FunctionEnd
...
Function un.onUninstSuccess
  HideWindow
  IfSilent End
  MessageBox MB_ICONINFORMATION|MB_OK "Το $(^Name) απεκαντεστάθηκα με επιτυχία από τον υπολογιστή σας."
End:
FunctionEnd
...
Section Uninstall
	...
	Delete "$SMPROGRAMS\AMIS\Βοήθεια (Greek).lnk"
  	Delete "$SMPROGRAMS\AMIS\Συμπτύξεις πληκτρολογίου (Greek).lnk"
