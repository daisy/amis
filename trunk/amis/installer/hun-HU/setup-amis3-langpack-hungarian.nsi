...
;**
Function un.onInit
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Biztosan eltávolítja az $(^Name) programot annak minden összetevõjével együtt?" IDYES +2
  Abort
FunctionEnd
...
Function un.onUninstSuccess
  HideWindow
  MessageBox MB_ICONINFORMATION|MB_OK "az $(^Name) eltávolítása a számítógéprõl sikeresen befejezõdött."
FunctionEnd
