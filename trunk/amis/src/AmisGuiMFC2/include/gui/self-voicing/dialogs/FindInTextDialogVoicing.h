...
#ifndef FINDTEXTDIALOG_VOICING_H
#define FINDTEXTDIALOG_VOICING_H
...
namespace amis
{
	namespace gui
	{
		namespace dialogs
		{
			class FindInTextDialogVoicing
			{
			private:
				amis::gui::dialogs::FindInTextDialog * mpDialog;

			public:
				FindInTextDialogVoicing(amis::gui::dialogs::FindInTextDialog * dlg);
				~FindInTextDialogVoicing(void);
...
#endif //FINDTEXTDIALOG_VOICING_H