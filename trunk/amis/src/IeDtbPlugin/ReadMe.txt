========================================================================
    ACTIVE TEMPLATE LIBRARY : PdtbIePlugin Project Overview
========================================================================

AppWizard has created this PdtbIePlugin project for you to use as the starting point for
...
_PdtbIePlugin.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_PdtbIePlugin.h)
        GUID definitions                                (_PdtbIePlugin_i.c)
        A type library                                  (_PdtbIePlugin.tlb)
        Marshaling code                                 (_PdtbIePlugin_p.c and dlldata.c)
PdtbIePlugin.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named PdtbIePlugin.pch and a precompiled types file named StdAfx.obj.
...
PdtbIePluginps.vcproj
	...
	dlldata.c, PdtbIePlugin_i.c and PdtbIePlugin_p.c which are required
